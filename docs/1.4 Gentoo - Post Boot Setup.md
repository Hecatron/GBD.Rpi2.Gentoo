...
There's some more details here on setting up a dispatcher with ntp

* https://fitzcarraldoblog.wordpress.com/2012/06/03/synchronise-your-gentoo-linux-clock-with-an-internet-time-server/

...
The first thing to do is to setup the clock, since this can mess up installs with emerge <br />
...
This uninstalled nano, so you may want to re-install nano afterwards if it's removed
...
TODO check this works for the RPi2

The RPi should have a hardware random number generator <br />
